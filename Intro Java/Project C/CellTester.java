 ...
 *
 * THIS CLASS IS COMPLETE; STUDENT MAY ADD TESTS TO IT FOR
 * TESTING PURPOSES, BUT WILL NOT HAND IT IN.
 */
public final class CellTester {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("Expect c1.equals(c2) to return false");
      ...
      System.out.println("Expect c1.hasEast() to be true");
      ...
      // Test setSouth method
      System.out.println("Adjusting just the south wall of c2");
      c2.setSouth(true);
      System.out.println("Expect c2.hasSouth() to now be true");
      System.out.println("c2.hasSouth() actually returns " + c2.hasSouth());
      System.out.println("Expect c2.toString() to now be 1011");
      System.out.println("c2.toString() actually returns " + c2.toString());
      System.out.println();
